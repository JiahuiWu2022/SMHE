...
typedef vector<ZZX> PolyVec;

class Ring2Utils {
public:

	static bool approxEqualVectors(PolyVec& v1, PolyVec& v2, double epsilon, ZZ modqQ, long modQ, long degree);
	// static bool approxEqualVectors(PolyVec& v1, PolyVec& v2, double epsilon);
